...
const Upload: React.FC = () => {
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
      ...
      // Redirect to Live Wall or Gallery after 2 seconds
      setTimeout(() => {
                  ...
                  {!preview ? (
                     <>
                        ...
                        <div className="w-full grid gap-4">
                           <button 
                             ...
                             className="w-full py-5 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-500 shadow-xl shadow-indigo-500/20 flex items-center justify-center gap-3 text-lg transform active:scale-95 transition-all"
                           >
                              <Camera size={24} /> Take Photo
                           </button>
                           <button 
                             onClick={() => fileInputRef.current?.click()}
                             className="w-full py-5 bg-slate-800 text-white font-bold rounded-2xl hover:bg-slate-700 flex items-center justify-center gap-3 text-lg"
                           >
                     ...
                     <div className="w-full flex flex-col items-center">
                        ...
                        <button 
                          ...
                          disabled={uploading}
                          className="w-full py-5 bg-green-500 text-white font-bold rounded-2xl hover:bg-green-400 shadow-xl shadow-green-500/20 flex items-center justify-center gap-3 text-lg transform active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                           {uploading ? (
                             <>Uploading...</>
                           ) : (
